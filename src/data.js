export const featuredPortfolio = [
  {
    ...
    desc: "A multi-environment AWS infrastructure project using Terraform, VPCs, subnets, EC2, IAM, CloudWatch, S3 remote state and DynamoDB locking.",
    visual: "iac",
  ...
  },
  {
    ...
    desc: "Automated build, test and deployment workflows with GitHub Actions and Bitbucket Pipelines, including Terraform plan/apply stages and approval gates.",
    visual: "pipeline",
    link: "https://github.com/MarcMaslen",
  },
  {
    id: 3,
    title: "AWS Lambda Automation Suite",
    type: "Serverless automation",
    desc: "Python and JavaScript Lambdas for resource cleanup, log rotation, notifications and scheduled/event-driven workflows with EventBridge.",
    visual: "lambda",
    link: "https://github.com/MarcMaslen",
  },
  {
